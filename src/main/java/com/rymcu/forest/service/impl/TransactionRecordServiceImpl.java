...
public class TransactionRecordServiceImpl
  ...
  @Resource private TransactionRecordMapper transactionRecordMapper;
  ...
  public TransactionRecord transfer(TransactionRecord transactionRecord) throws Exception {
    // 判断发起者账户状态
    boolean formAccountStatus =
        checkFormAccountStatus(
            transactionRecord.getFormBankAccount(), transactionRecord.getMoney());
    if (formAccountStatus) {
      Integer result =
          transactionRecordMapper.transfer(
              transactionRecord.getFormBankAccount(),
              transactionRecord.getToBankAccount(),
  ...
  @Override
  public TransactionRecord transferByUserId(Integer toUserId, Integer formUserId, BigDecimal money)
      throws Exception {
