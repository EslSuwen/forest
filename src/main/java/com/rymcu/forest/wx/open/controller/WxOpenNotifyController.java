...
public class WxOpenNotifyController {
  ...
  @Autowired protected WxOpenServiceHandler wxOpenService;

  /** 全网发布官方测试小程序 AppId */
  private static final String testMiniProgramAppId = "wxd101a85aa106f53e";
  /** 全网发布官方测试公众号 AppId */
  private static final String testMpAppId = "wx570bc396a51b8ff8";

  private static final String TESTCOMPONENT_MSG_TYPE_TEXT = "TESTCOMPONENT_MSG_TYPE_TEXT";
  private static final String TESTCOMPONENT_MSG_TYPE_TEXT_callback =
